   ...
   <!-- //skip  -->
    ...
    <main>
        ...
        <section id="signUpCont">
                <div class="signUp">
                    <h1><strong>hyunseo</strong> 사이트에 오신 것을 환영합니다.</h1>
                    <form name="signUp" method="post" action="signUpSave.php">
                        <fieldset>
                            ...
                            <div>
                                ...
                                <input type="email" name="userEmail" id="userEmail" class="input-text" placeholder="이메일을 입력해 주세요" required autofocus>
                            </div>
                            <div>
                                <label for="userName" class="sr-only">이름</label>                               
                                <input type="text" name="userName" id="userName" class="input-text" placeholder="이름을 입력해 주세요" required>
                            </div>
                            <div>
                                <label for="userNickName" class="sr-only">닉네임</label>  
                                <input type="text" name="userNickName" id="userNickName" class="input-text" placeholder="활동에 필요한 닉네임을 입력해 주세요" required>
                            </div>
                            <div>
                                <label for="userPW" class="sr-only">패스워드</label>  
                                <input type="text" name="userPW" id="userPW" class="input-text" placeholder="패스워드를 입력해 주세요" required>
                            </div>
                            <div class="birth">
                                <div>
